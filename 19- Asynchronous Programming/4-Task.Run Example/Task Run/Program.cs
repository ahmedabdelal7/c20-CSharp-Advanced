...
class RunMultipleTasks
{
    static async Task Main(string[] args)
    {
        ...
        Task task1 = Task.Run(() => DownloadFile("Download File 1")); // Create New Thread

        Task task2 = Task.Run(() => DownloadFile("Download File 2")); // Create New Thread
    ...
    {
        Console.WriteLine($"{TaskName}: Started! With Thread ID: {Thread.CurrentThread.ManagedThreadId}");
